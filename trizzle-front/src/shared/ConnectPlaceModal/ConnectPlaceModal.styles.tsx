...
export const PlaceListContainer = styled.button`
  display: flex;
  justify-content: flex-start;
  align-items: center;
  width: 20rem;
...
export const PlaceText = styled.button`
  padding: 0 0.5rem;
  width: 7rem;
  height: 100%;
  font-size: 1.2rem;
...
export const PlaceTitleText = styled.button`
  margin: 0 0 0 0.5rem;
  font-size: 1rem;
  font-weight: 500;
`

export const PlaceDateText = styled.button`
  margin: 0 0 0 0.5rem;
  font-size: 0.8rem;
  font-weight: 300;
  color: #747474;
